...
public class SettingsService {
    ...
    private static final String DEFAULT_MUSIC_FILE_TYPES = "mp3 ogg oga aac m4a m4b flac wav wma aif aiff ape mpc shn";
    ...
    private static final String DEFAULT_DOWNSAMPLING_COMMAND = "ffmpeg -i %s -acodec libmp3lame -b:a %bk -f mp3 -";
